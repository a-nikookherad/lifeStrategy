        ...
        <div id="sidebar-collapse">
            <div class="admin-block d-flex flex-column">
                <div class="align-self-center">
                    <img src="{{asset("assets/img/websiteLogo.png")}}" width="70px" class="img-circle"/>
                </div>
...
<script src="{{asset("admin/assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js")}}"
        type="text/javascript"></script>
<!-- PAGE LEVEL PLUGINS-->
<script src="{{asset("admin/assets/vendors/chart.js/dist/Chart.min.js")}}" type="text/javascript"></script>
<script src="{{asset("admin/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js")}}"
        type="text/javascript"></script>
<script src="{{asset("admin/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js")}}"
        type="text/javascript"></script>
<script src="{{asset("admin/assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js")}}"
        type="text/javascript"></script>
<!-- CORE SCRIPTS-->
